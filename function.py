...
def main():
    try:
        ...
        splitter = Splitter()
        postagger = POSTagger()
        dicttagger = DictionaryTagger([ '/sentiments/positive.yml', '/sentiments/negative.yml', 
                                        '/sentiments/inc.yml', '/sentiments/dec.yml', '/sentiments/inv.yml'])
